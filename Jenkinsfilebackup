...
pipeline {
  ...
  stages {
      ...
      parallel {
        stage ('Build EE') {
          ...
          steps {
            ...
            stash includes: 'src/github.com/teamjupitergmu/jupiterserver/dist/**', name: 'eedist'
          }
        }
        stage ('Build TE') {
          agent {
          ...
          steps {
            ...
            stash includes: 'src/github.com/teamjupitergmu/jupiterserver/dist/**', name: 'tedist'
          }
        }
      }
    }
    ...
    stage ('Build Docker mattermost-enterprise-edition') {
      ...
      steps {
        dir('src/github.com/teamjupitergmu/jupiterserver') {
